...
--
-- Host: localhost
-- Generation Time: Nov 18, 2016 at 06:41 PM
...
(1, 'هنر فوق العاده زیبای شیشه گری', 'http://google.com', 'اکولایزر صوتی زیبای پشت شیشه ماشین', 'data/slideshow/0-4141-f44ae5f0ac601bebdd54e8c87ab92c8b.jpg'),
(2, 'تیونینگ', 'http://yahoo.com', 'زیر روکش پلاستیکی درب یک سوراخ بسیار ریز زده میشه و لوگو نصب میشه که به هیچ وجه منبع نوری معلوم نیست مگر اینکه با درب باز یکی رو زیر کنید', 'data/slideshow/0-4138-ec12698fabcbce58d8ca07b213c186a3.jpg'),
(4, 'ال ای دی', 'yahoo.com', 'لامپ های ال ای دی هالوژن زنون', 'data/slideshow/0-8633-6161d8c749d6fc69bcff23c28fbc7db9.jpg');
